...
# -----------------------------------------------------------------------------
BINNAME = proj_mps.x
CPPSRC	= main.cpp utils.cpp densitymat.cpp SpinHamiltonian.cpp schmidt.cpp mps_gen.cpp timer.cpp schedule.cpp mps_op.cpp
...
# -----------------------------------------------------------------------------
CFLAGS	= $(INCLUDE) -O3 -std=c++11 -D_HAS_CBLAS -D_HAS_INTEL_MKL -fopenmp -D_COMPLEX
